...
class CommonStringLocalization {
  ...
  String deleteDialogDefaultTitle() =>
      Intl.message(
          'Are you sure?',
  ...
  String deleteDialogDefaultMessage() =>
      Intl.message(
  ...
  String editItemConfirmationTitle() => Intl.message(
  ...
  String deleteItemConfirmationTitle() => Intl.message(
      'Are you sure you want to edit this item?',
  ...
  String slideAvocadoToConfirm() => Intl.message(
      'Slide the avocado to confirm',
      name: 'slideAvocadoToConfirm',
      args: [],
      desc: 'Text to show in the confirmation slider used when deleting or editing important data.');
  ...
  String conflictingItemSelectionDialogTitle() => Intl.message(
      ...
      args: [],
      desc: 'Title for the dialog shown when you have to choose between food items in a meal plan');
  ...
  String conflictingItemSelectionDialogMessageOne() => Intl.message(
      ...
      args: [],
      desc: 'Message for the dialog shown when you have to choose between food items in a meal plan');
  ...
  String conflictingItemMealPlanItemTitle() => Intl.message(
      'Item in meal plan',
      name: 'conflictingItemMealPlanItemTitle',
      args: [],
      desc: 'Title shown in the meal plan food item when displaying the two conflicting food items side by side.');

  String conflictingItemDatabaseItemTitle() => Intl.message(
      'Database Food Item',
      name: 'conflictingItemDatabaseItemTitle',
      args: [],
      desc: 'Title shown in the database food item when displaying the two conflicting food items side by side.');

  String confirmYourSelection() => Intl.message(
  ...
  String updateDatabaseWithMealPlanItemTitle() => Intl.message(
  ...
  String updateDatabaseWithMealPlanItemMessageThree() => Intl.message(
      'Note: You can always select \"no\" do this later.',
      name: 'updateDatabaseWithMealPlanItemMessageThree',
      args: [],
      desc: 'Update database with meal plan item dialog message');

  String pleaseConfirmUpdate() => Intl.message(
  ...
  String weDontWantYourDataToGetLost() => Intl.message(
  ...
  String weWillUpdateThisFoodItemInMealPlan() => Intl.message(
      ...
      args: [],
      desc: 'Message for the confirmation dialog when we are about to update a food item in meal plan.');

  String noChangesHaveBeenMade() => Intl.message(
      'No changes have been made',
      name: 'noChangesHaveBeenMade',
      args: [],
      desc: 'Title for the dialog shown when no changes were made to meal plan.');
  ...
  String weWillKeepUsingADifferentVersion() => Intl.message(
      ...
      args: [],
      desc: 'Message for the dialog shown when no changes were made to meal plan.');
  ...
  String theItemWillStillBeMarkedAsNotSynced() => Intl.message(
      ...
      args: [],
      desc: 'Message when the item in a meal will still be marked as out-of-sync.');

  String weHaveUpdatedYourMealPlan() => Intl.message(
      'We have updated your meal plan!',
      name: 'weHaveUpdatedYourMealPlan',
      args: [],
      desc: 'Title of dialog shown when an item in the meal plan has been updated');
  ...
  String theFoodItemNowMatchesTheDatabase() => Intl.message(
      ...
      args: [],
      desc: 'Message of dialog shown when an item in the meal plan has been updated');
  //The food item in your meal plan now matches the food item in your database and will now be marked as synced.

  String shareMealPlan() => Intl.message(
      'Share meal plan',
      name: 'shareMealPlan',
      args: [],
  ...
  String areYouSureYouWantToDeleteMealPlan() => Intl.message(
      ...
      args: [],
      desc: 'Title for the confirmation dialog shown when trying to delete meal plan.');
  ...
  String theFoodPlanWillBeDeleted() => Intl.message(
      ...
      args: [],
      desc: 'Message for the confirmation dialog shown when trying to delete meal plan.');

  String foodPlanEditorHelp() => Intl.message(
      'Food Plan Editor Help',
      name: 'foodPlanEditorHelp',
      args: [],
      desc: 'Title for the editor\'s help dialog');

  String editFoodPortion() => Intl.message(
      'Edit Food Portion',
      name: 'editFoodPortion',
      args: [],
      desc: 'Title for the edit food portion dialog');

  String newFoodPortion() => Intl.message(
      'New Food portion',
      name: 'newFoodPortion',
      args: [],
      desc: 'Title for the new food portion dialog');

  String deleteFoodPortion() => Intl.message(
      'Delete Portion',

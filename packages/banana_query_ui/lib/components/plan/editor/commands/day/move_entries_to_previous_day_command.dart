...
class MoveEntriesToPreviousDayCommand extends CommandBase {
  MoveEntriesToPreviousDayCommand({ required this.entries });
  ...
  @override
  String get type => "MoveEntryToPreviousDayCommand";

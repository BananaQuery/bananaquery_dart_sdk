...
class FoodPlanEntryTile extends StatelessWidget {
  ...
  const FoodPlanEntryTile({Key? key,
    required this.entry,
    this.trailing,
    this.color,
              ...
              child: DottedBorder(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(entry.item.name ?? "", style: titleStyle, overflow: TextOverflow.ellipsis,),
                      Text("${entry.quantity} ${entry.portion.title}", style: subtitleStyle, overflow: TextOverflow.clip,),
                    ],
                  ),

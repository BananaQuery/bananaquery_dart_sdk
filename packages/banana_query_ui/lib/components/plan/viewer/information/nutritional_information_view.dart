...
class NutritionalInformationView extends StatefulWidget {
  const NutritionalInformationView({super.key,
    required this.entry,
    this.onEntryChanged,
...
class NutritionalInformationViewState extends State<NutritionalInformationView> {
              ...
              child: DefaultTabController(
                  ...
                  child: Scaffold(
                      ...
                      body: Column(
                        children: [
                          const TabBar(
                            padding: const EdgeInsets.only(bottom: 15.0, top: 15.0, left: 20.0),
                            tabs: [
                              Tab(
                                child: Text("Nutritional info", style: TextStyle(color: Colors.black87),),
                              ),
                              Tab(
                                child: Text("Portions", style: TextStyle(color: Colors.black87))
                              ),
                            ],
                          ),
                          Expanded(
                                  ...
                                  children: [
                                    Container(
                                      child: Column(
                                        children: [
                                          Padding(
                                            padding: const EdgeInsets.only(bottom: 0.0, top: 15.0, left: 20.0),
                                            child: Row(
                                              children: [
                                                SizedBox(
                                                    width: 300,
                                          ...
                                          Row(
                                            children: [
                                              SizedBox(
                                                  ...
                                                  width: 170,
                                                  child: BodStatsCard(
                                                    value: macroTotals?.kilocalories.amount.toStringAsFixed(2) ?? "?",
                                                    color: Colors.white,
                                                    subtitle: 'Energy',
                                                    units: '',
                                                    child: SizedBox(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        initialValue: macroTotals?.kilocalories.amount.toString(),
                                                        style: Theme.of(context).textTheme.titleMedium!.copyWith(fontSize: 28.0),
                                                        decoration: InputDecoration(
                                                          suffixText: macroTotals!.kilocalories.units,
                                                          isDense: true,
                                                          suffixStyle: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 24),
                                                          border: InputBorder.none,
                                                        ),
                                                      ),
                                                    )
                                              ...
                                              SizedBox(
                                                  ...
                                                  width: 150,
                                                  child: BodStatsCard(
                                                    value: macroTotals?.carbs.amount.toStringAsFixed(2) ?? "?",
                                                    color: Colors.white,
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: TextFormField(
                                                        enabled: isFoodItemEditable,
                                                        initialValue: macroTotals?.carbs.amount.toString(),
                                                        style: Theme.of(context).textTheme.titleMedium!.copyWith(fontSize: 28.0),
                                                        decoration: InputDecoration(
                                                          suffixText: macroTotals!.carbs.units,
                                                          isDense: true,
                                                          suffixStyle: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 24),
                                                          border: InputBorder.none,
                                                        ),
                                              ...
                                              SizedBox(
                                                  ...
                                                  width: 150,
                                                  child: BodStatsCard(
                                                    value: macroTotals?.proteins.amount.toStringAsFixed(2) ?? "?",
                                                    color: Colors.white,
                                                    subtitle: 'Proteins',
                                                    units: '',
                                                    child: SizedBox(
                                                      ...
                                                      child: TextFormField(
                                                        enabled: isFoodItemEditable,
                                                        initialValue: macroTotals?.proteins.amount.toString(),
                                                        style: Theme.of(context).textTheme.titleMedium!.copyWith(fontSize: 28.0),
                                                        decoration: InputDecoration(
                                                          suffixText: macroTotals!.proteins.units,
                                                          isDense: true,
                                                          suffixStyle: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 24),
                                                          border: InputBorder.none,
                                                        ),
                                              ...
                                              SizedBox(
                                                  ...
                                                  width: 150,
                                                  child: BodStatsCard(
                                                    value: macroTotals?.fats.amount.toStringAsFixed(2) ?? "?",
                                                    color: Colors.white,
                                                    subtitle: 'Fats',
                                                    units: '',
                                                    child: SizedBox(
                                                      ...
                                                      child: TextFormField(
                                                        enabled: isFoodItemEditable,
                                                        initialValue: macroTotals?.fats.amount.toString(),
                                                        style: Theme.of(context).textTheme.titleMedium!.copyWith(fontSize: 28.0),
                                                        decoration: InputDecoration(
                                                          suffixText: macroTotals!.fats.units,
                                                          isDense: true,
                                                          suffixStyle: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 24),
                                                          border: InputBorder.none,
                                                        ),
                                                ...
                                                Wrap(
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: NutrientTable(
                                                          title: "Mineral",
                                                          values: NutrientTotalsCalculator.getNutrientTotals<Mineral>([_entry]),
                                                          editable: isFoodItemEditable
                                                      ),
                                                    ),
                                                    NutrientTable(
                                                      title: "Vitamin",
                                                      values: NutrientTotalsCalculator.getNutrientTotals<Vitamin>([_entry]),
                                                      editable: isFoodItemEditable
                                                    ),
                                                  ],
                                                ),
